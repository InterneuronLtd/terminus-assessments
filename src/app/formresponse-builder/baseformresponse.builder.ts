...
export class BaseFormResponseBuilder {
    ...
    BuildFormResponse(submission: any, formResponse: CoreFormResponse): any {
        ...
        //Delete the saveAsDraft for the submission
        delete submission["data"]["saveAsDraft"];
        ...
        if (!submission["data"]["completedDate"]) {
        ...
        formResponse.responseversion = (submission.state == "draft" ? formResponse.responseversion : formResponse.responseversion + 1);
